  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Hello Sudhiksha! 👋', style: TextStyle(color: Colors.black87, fontWeight: FontWeight.bold, fontSize: 18)),
        actions: [
          ...
          children: [
            Row(
              children: [
                Container(
                  width: 10,
                  height: 10,
                  decoration: BoxDecoration(color: _isOnline ? const Color.fromARGB(255, 76, 175, 80) : const Color.fromARGB(255, 221, 27, 27), shape: BoxShape.circle),
                ),
                const SizedBox(width: 8),
                Text(_isOnline ? 'You are Online' : 'You are Offline', style: const TextStyle(fontWeight: FontWeight.w600, fontSize: 13)),
              ],
            ),
            ...
            Container(
              ...
              decoration: BoxDecoration(
                gradient: const LinearGradient(colors: [Color(0xFF6B51FF), Color(0xFF4A30D8)]),
                  ...
                  Row(
                    ...
                    children: [
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('Jobs Completed', style: TextStyle(color: Colors.white70, fontSize: 11)),
                      ...
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('Hours Worked', style: TextStyle(color: Colors.white70, fontSize: 11)),
                          Text('5h 30m', style: TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.bold)),
                        ],
                      ),
                    ],
                  ),
              ...
              child: Row(
                ...
                children: [
                  const Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('Available for Bookings', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 13)),
                      Text('You will receive new service requests', style: TextStyle(color: Color.fromARGB(255, 13, 13, 13), fontSize: 11)),
                    ],
                  ),
                  Switch(
                    value: _isOnline,
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                const Text('New Service Requests', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                TextButton(onPressed: () {}, child: const Text('View all', style: TextStyle(color: Color(0xFF5B40F4)))),
              ],
            ),
              ...
              itemBuilder: (context, index) {
                ...
                return Padding(
                  ...
                  child: GestureDetector(
                    onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => ServiceRequestScreen(requestData: request))),
                    child: Container(
                      padding: const EdgeInsets.all(16),
                      decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(16)),
                      child: Row(
                        children: [
                          CircleAvatar(radius: 24, backgroundColor: request['avatarColor'], child: const Icon(Icons.person, color: Colors.white)),
                          const SizedBox(width: 12),
                          Expanded(
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text(request['title'], style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 15)),
                                const SizedBox(height: 4),
                                Text(request['time'], style: const TextStyle(color: Color.fromARGB(255, 11, 11, 11), fontSize: 12)),
                                Text(request['location'], style: const TextStyle(color: Color.fromARGB(255, 11, 11, 11), fontSize: 12)),
                              ],
                            ),
                          ),
                          Text(request['amount'], style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 16, color: Color(0xFF5B40F4))),
                        ],
                      ),
                    ),
                  ),
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                const Text('Upcoming Bookings', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                TextButton(onPressed: () {}, child: const Text('View all', style: TextStyle(color: Color(0xFF5B40F4)))),
              ],
            ),
            Container(
              ...
              child: Row(
                children: [
                  const CircleAvatar(radius: 24, backgroundColor: Colors.blueAccent, child: Icon(Icons.person, color: Colors.white)),
                  const SizedBox(width: 12),
                  const Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('Patient Care', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15)),
                        SizedBox(height: 4),
                        Text('12 May, 4:00 PM', style: TextStyle(color: Color.fromARGB(255, 5, 5, 5), fontSize: 12)),
                        Text('HSR Layout, Bengaluru', style: TextStyle(color: Color.fromARGB(255, 5, 4, 4), fontSize: 12)),
                      ],
                    ),
                  ),
                  Container(
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: const [
                        ...
                        SizedBox(width: 4),
                        Text('4.8 (128 reviews)', style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold)),
                      ],
                    ),
                  ),
                ],
                ...
                children: [
                  ...
                  Column(
                    children: const [
                      ...
                      SizedBox(height: 4),
                      Text('Jobs Completed', style: TextStyle(fontSize: 12, color: Colors.grey)),
                    ],
                  ),
                  Container(width: 1, height: 40, color: Colors.grey.shade300),
                  Column(
